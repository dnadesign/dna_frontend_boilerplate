 ...
 */
DO.SendEvent = function(category, action, label, value) {
	// return true;
	if (typeof dataLayer !== 'undefined') {
		if (typeof value !== 'undefined') {
			DO.Log('ga event: ' + category + ' ' + action + ' ' + label + ' ' + value);
			dataLayer.push({
				'event': 'website',
			...
			DO.Log('ga event: ' + category + ' ' + action + ' ' + label);
			dataLayer.push({
				'event': 'website',
			    'eventCategory': category,
			    'eventAction': action,
			...
			DO.Log('ga event: ' + category + ' ' + action);
			dataLayer.push({
				'event': 'website',
			    'eventCategory': category,
			    'eventAction': action,
