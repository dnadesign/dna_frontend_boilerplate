				...
				route(args, function (options) {
						...
						ready(function() { // Ready. Yea mofo.
								...
								if (elemset.dynamic && (elemset.custom || lowestNonZeroBP < screenMax)) {
									...
									orientationchange(resizeHandler, resizeName);
								}
