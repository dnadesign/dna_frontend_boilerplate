...
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><!-- right at the top or it will be ignored, forces IE into the best mode -->
	<title><?php $var = explode('/', $_SERVER['SCRIPT_FILENAME']); echo $var[count($var) - 1]; ?> &raquo; SiteName</title>
	<meta name="description" content="description">
	<meta name="keywords" content="keywords">
	<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, user-scalable=no"><!-- controls page sizing and zooming on mobile devices -->
	<meta name="apple-mobile-web-app-title" content="SiteName"><!-- apple home screen title -->
	...
	<link rel="stylesheet" type="text/css" href="/css/dist/xlarge.min.css" />
